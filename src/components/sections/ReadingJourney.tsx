...
export default function ReadingJourney() {
  return (
    <section className="px-4 md:px-8 lg:px-0 lg:max-w-292.5 container mx-auto">
      ...
      >
        ...
        <div className="space-y-8 md:space-y-12">
          <h2 className="text-34 leading-130 tracking-tight-3 font-semibold font-martian text-neutral-900 md:text-50 lg:max-w-lg lg:mx-auto lg:text-center">
